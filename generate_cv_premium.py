...
pdf.set_x(10)
pdf.multi_cell(55, 5, "JavaScript, HTML/CSS,\nPHP, Python", align="L")
...
pdf.set_text_color(200, 200, 200)
pdf.set_x(10)
pdf.multi_cell(55, 5, "React, Node.js", align="L")
...
pdf.set_text_color(200, 200, 200)
pdf.set_x(10)
pdf.multi_cell(55, 5, "Phát triển phần mềm tinh gọn\nTối ưu hóa UI/UX\nClean Code & Architecture", align="L")
...
pdf.line(LEFT_MARGIN, 62, LEFT_MARGIN + 15, 62)
...
pdf.set_font("BeVietnamPro", "", 10)
pdf.set_text_color(70, 70, 70)
pdf.multi_cell(115, 5.5, "Trang chủ mang cấu trúc UX cao cấp, tích hợp Chatbot AI và dark theme. Deploy qua FTP với workflow CI/CD.")
...
pdf.set_font("BeVietnamPro", "", 10)
pdf.set_text_color(70, 70, 70)
pdf.multi_cell(115, 5.5, "Cung cấp, đảm bảo mã nguồn cho nhiều hệ thống kinh doanh nhỏ gọn, tối ưu API và kiến trúc phần mềm.")
